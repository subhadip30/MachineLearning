...
with col2:
    github_btn = st.button("📥 Download from GitHub", key="github_btn", use_container_width=True)
...
if st.session_state.data_source == "upload":
    ...
    st.subheader("📥 Loading from GitHub...")
    try:
        # Hardcoded GitHub path
        github_url = "https://raw.githubusercontent.com/subhadip30/MachineLearning/refs/heads/main/data/emp_data.csv?raw=true"
